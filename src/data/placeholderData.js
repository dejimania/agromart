export const data = {
  ...
  products: [
      ...
      { id: 3, name: "P3", category: "Tubers",
         description: "P3 (Tuber)", price: 20 },
      { id: 4, name: "P4", category: "Fruits",
         description: "P4 (Fruits)", price: 10 },
      { id: 5, name: "P5", category: "Vegetables",
         description: "P6 (Vegetables)", price: 5 },
  ]
};